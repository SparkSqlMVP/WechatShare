    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            //inputObj.SetValue("appid", System.Configuration.ConfigurationManager.AppSettings["wechat.AppId"]);//公众账号ID
            //inputObj.SetValue("mch_id", System.Configuration.ConfigurationManager.AppSettings["wechat.MchId"]);//商户号
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            //inputObj.SetValue("appid", System.Configuration.ConfigurationManager.AppSettings["wechat.AppId"]);//公众账号ID
            //inputObj.SetValue("mch_id", System.Configuration.ConfigurationManager.AppSettings["wechat.MchId"]);//商户号
            //inputObj.SetValue("nonce_str", System.Configuration.ConfigurationManager.AppSettings["wechat.AppSecret"]);//随机字符串
            inputObj.SetValue("sign", inputObj.MakeSign());//签名
            ...
            byte[] postdatabyte = Encoding.UTF8.GetBytes(xml);
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            //{
            //    inputObj.SetValue("notify_url", System.Configuration.ConfigurationManager.AppSettings["wechat.NotifyUrl"]);//异步通知url
            //}
        ...
        */
        public static string GenerateOutTradeNo()
        {
            var ran = new Random();
            return "";
            //return string.Format("{0}{1}{2}", System.Configuration.ConfigurationManager.AppSettings["wechat.MchId"], DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(999));
        }
